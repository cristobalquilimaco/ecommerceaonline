...
const Banner = () => {
  ...
  return (
      ...
      <ul className="icon_info_banner">
              <li className="icon__and_info"><img className="icon_individual" src={icon1} alt="" /><p>30 days for exchanges or returns.</p></li>
              <li className="icon__and_info"><img className="icon_individual" src={icon2} alt="" /><p>Free shipping on all products to more than 930 municipalities.</p></li>
              <li className="icon__and_info"><img className="icon_individual" src={icon3} alt="" /><p>You can earn half of your purchase.</p></li>
              <li className="icon__and_info"><img className="icon_individual" src={icon4} alt="" /><p>Compra en línea y recoge en tienda.</p></li>
            </ul>
